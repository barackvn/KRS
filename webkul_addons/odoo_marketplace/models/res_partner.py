...
class ResPartner(models.Model):
    ...
    def approve(self):
        ...
        if self.seller:
            ...
            #         res = lead.convert_opportunity(self.id, [], False)
    ...
    def action_seller_globel_settings(self):
        ...
        _logger.info("~~~~~~~~form_view_id~~~~~~~~~%r~~~~~~~~~~~~~",form_view_id)
        return {
