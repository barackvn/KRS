...
class ResUsers(models.Model):
    ...
    def signup(self, values, token=None):
        ...
        if is_seller := values.get('is_seller'):
    ...
    def copy(self, default=None):
        ...
        if website := self._context.get('website_id', False):
    ...
    def check_user_is_seller(self):
        ...
        return bool(
            self.partner_id.seller
            and self.has_group(seller_grp)
            and not self.has_group(officer_grp)
        )
    ...
    def check_user_is_draft_seller(self):
        ...
        return bool(
            self.partner_id.seller
            and self.has_group(draft_seller_grp)
            and not self.has_group(seller_grp)
        )

    def check_user_is_mp_officer(self):
        officer_grp = 'odoo_marketplace.marketplace_officer_group'
        return bool(self.has_group(officer_grp))
    ...
    def is_marketplace_user(self):
        draft_seller_grp = 'odoo_marketplace.marketplace_draft_seller_group'
        return bool(self.has_group(draft_seller_grp))
