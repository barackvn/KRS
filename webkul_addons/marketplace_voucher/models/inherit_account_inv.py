...
class AccountMove(models.Model):
    ...
    def create_seller_payment_new(self, sellers_dict):
        ...
        if invoice_id := sellers_dict.get('invoice_id', False):
            ...
            if invoice_obj and invoice_obj.type in ['out_invoice', 'out_refund']:
                ...
                voucher_obj = order.applied_voucher or False
        ...
        return super(AccountMove, self).create_seller_payment_new(sellers_dict)
