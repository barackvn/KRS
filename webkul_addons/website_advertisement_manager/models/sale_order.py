...
class SaleOrderLine(models.Model):
    ...
    ad_total_days = fields.Integer("Number Of Days", readonly=True, compute="_compute_total_ad_days", store=True)
    ad_block_status = fields.Selection([
        ("draft", "Draft"),
        ("active", "Active"),
        ("expire", "Expired"),
    ], string="Status", default="draft", compute="_compute_ad_block_status", search="_search_ad_block_status", store=True)
